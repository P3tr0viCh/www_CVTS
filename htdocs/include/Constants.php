...
class Thresholds
{
    ...
    // Дни
    const SENSORS_INFO_DATETIME_STATUS_WARNING_YELLOW = 7;
    const SENSORS_INFO_DATETIME_STATUS_WARNING_RED = 4;
    // Часы
    const SENSORS_INFO_DATETIME_CURRENT_WARNING_YELLOW = 12;
    const SENSORS_INFO_DATETIME_CURRENT_WARNING_RED = 24;
}
...
class SensorsInfoType
{
    const SENSORS_INFO_STATUS = 0;
    const SENSORS_INFO_ZEROS_CURRENT = 1;
    const SENSORS_INFO_ZEROS_INITIAL = 2;
}