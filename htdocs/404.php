...
echoHead($newDesign, S::ERROR_404_TITLE);
...
echo '<h1 class="result-message error-num color-text--error">' . S::ERROR_404 . '</h1>' . PHP_EOL;
echo S::TAB . S::TAB . S::TAB;
echo '<h1 class="result-message color-text--error">' . S::ERROR_404_HEADER . '</h1>' . PHP_EOL;
echo S::TAB . S::TAB . S::TAB;
echo '<h2 class="result-message color-text--secondary">' . S::ERROR_404_SUB_HEADER . '</h2>' . PHP_EOL;
